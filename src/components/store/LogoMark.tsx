...
export function LogoMark({ className }: LogoMarkProps) {
  return (
    <div className={cn("flex items-center gap-2 md:gap-5 group cursor-pointer", className)}>
      {/* Container da bolinha com ID para controle via Navbar */}
      <span id="logo-ball" className="transition-all duration-500 block shrink-0">
        <div className="relative flex h-10 w-10 md:h-16 md:w-16 items-center justify-center rounded-full bg-white shadow-editorial border border-primary/5 transition-all duration-500 group-hover:shadow-premium group-hover:scale-105 group-hover:-translate-y-1">
