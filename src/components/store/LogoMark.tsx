    ...
    <div className="flex flex-col items-center group cursor-pointer">
      ...
      <div className="relative flex h-12 w-12 items-center justify-center mb-1">
        ...
        <div className="relative flex flex-col items-center justify-center">
          <span className="text-[14px] font-headline font-bold text-primary tracking-tighter leading-none">TB</span>
          <div className="h-[1px] w-2 bg-accent/40 mt-0.5" />
        </div>
      </div>
      
      {/* Brand Typography */}
      <div className="flex flex-col items-center">
        <h1 className="text-2xl md:text-3xl font-headline font-bold tracking-tight text-primary leading-none">
          Toda Bela
        </h1>
        <div className="flex items-center gap-2 mt-1">
          <div className="h-[0.5px] w-4 bg-accent/30" />
          <p className="text-[9px] uppercase font-bold tracking-[0.4em] text-accent">Maison de Mode</p>
          <div className="h-[0.5px] w-4 bg-accent/30" />
        </div>
      </div>
    </div>
